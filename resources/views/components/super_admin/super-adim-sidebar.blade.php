<section id="sidebar">
    <a href="{{ route('super_admin_home') }}" class="brand">
        <i class='bx bxs-smile  bx-lg'></i>
        <span class="text">AdminHub</span>
    </a>
    <ul class="side-menu top">
        <li class="{{ request()->routeIs('super_admin_home') ? 'active' : '' }}">
        ...
        <li
            class="{{ request()->routeIs('super_admin_products', 'super_admin_products_active', 'super_admin_products_blocked', 'super_admin_products_deleted') ? 'active' : '' }}">
        ...
        <li
            class="{{ request()->routeIs('super_admin_categories', 'super_admin_categories_active', 'super_admin_categories_blocked', 'super_admin_categories_deleted') ? 'active' : '' }}">
        ...
        <li
            class="{{ request()->routeIs('super_admin_branches', 'super_admin_branches_active', 'super_admin_branches_blocked', 'super_admin_branches_deleted') ? 'active' : '' }}">
        ...
        <li
            class="{{ request()->routeIs('super_admin_users', 'super_admin_users_active', 'super_admin_users_blocked', 'super_admin_users_deleted') ? 'active' : '' }}">
            <a href="{{ route('super_admin_users') }}">
                <i class='bx bxs-group bx-sm'></i>
                <span class="text">Utilisateurs/Admins</span>
            </a>
        </li>
    </ul>
    <ul class="side-menu bottom">
        <li class="{{ request()->routeIs('super_admin_profile') ? 'active' : '' }}">
            <a href="{{ route('super_admin_profile') }}">
