<div id="searchProductModal" class="modal-overlay" data-block-url="{{ route('products.block') }}"
    data-unblock-url="{{ route('products.unblock') }}" data-delete-url="{{ route('products.delete') }}"
    data-restore-url="{{ route('products.restore') }}" data-erase-url="{{ route('products.erase') }}"
