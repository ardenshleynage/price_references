<div id="searchUserModal" class="modal-overlay" data-block-url="{{ route('users.block') }}"
    data-unblock-url="{{ route('users.unblock') }}" data-delete-url="{{ route('users.delete') }}"
    data-restore-url="{{ route('users.restore') }}" data-erase-url="{{ route('users.erase') }}"
    ...
    <div class="login modal-content" onclick="event.stopPropagation()">
        ...
        <div class="login-container">
            ...
            <p><strong>E-mail :</strong> <span id="searchModalUserEmail"></span></p>
