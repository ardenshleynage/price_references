<div id="productModal" data-block-url="{{ route('products.block') }}" data-unblock-url="{{ route('products.unblock') }}"
    data-delete-url="{{ route('products.delete') }}" data-restore-url="{{ route('products.restore') }}"
    data-permanent-delete-url="{{ route('products.erase') }}" data-update-url="{{ route('products.update') }}"
