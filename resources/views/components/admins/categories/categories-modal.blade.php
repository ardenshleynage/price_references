<div id="categoryModal" data-block-url="{{ route('admins.categories.delete') }}"
    data-delete-url="{{ route('admins.categories.delete') }}" data-restore-url="{{ route('admins.categories.restore') }}"
    data-permanent-delete-url="{{ route('admins.categories.erase') }}"
    data-update-url="{{ route('admins.categories.update') }}" class="modal-overlay" onclick="closeUserModal(event)">
