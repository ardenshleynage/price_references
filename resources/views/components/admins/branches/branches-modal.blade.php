<div id="branchesModal" data-block-url="{{ route('admins.branches.delete') }}"
    data-delete-url="{{ route('admins.branches.delete') }}"
    data-restore-url="{{ route('admins.branches.restore') }}"
    data-permanent-delete-url="{{ route('admins.branches.erase') }}"
    data-update-url="{{ route('admins.branches.update') }}" class="modal-overlay" onclick="closeUserModal(event)">
