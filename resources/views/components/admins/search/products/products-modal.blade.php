<div id="searchProductModal" class="modal-overlay" data-block-url="{{ route('admins.products.delete') }}"
    data-unblock-url="" data-delete-url="" data-restore-url="{{ route('admins.products.restore') }}"
    data-erase-url="{{ route('admins.products.erase') }}" onclick="closeSearchProductModal(event)">
