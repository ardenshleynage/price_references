    <main class="main-content">
        <div class="page-header">
            <div class="page-header-left">
                <h1>Utilisateurs</h1>
                <span class="item-count" id="itemCount">0 utilisateur(s)</span>
            </div>
            <button class="add-btn" id="addUserBtn" onclick="openAddUserModal()" style="display: none;">
        ...
        <div class="access-denied-content" id="accessDeniedContent" style="display: none;">
