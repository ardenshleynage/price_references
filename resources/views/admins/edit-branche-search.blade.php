...
<body>
    ...
    <div class="login">
        ...
        <form method="POST" action="{{ route('admins.branches.update_from_search') }}" class="login-container">
            @csrf
            <input type="hidden" name="branche_id" value="{{ $branche->id }}">
            <input type="hidden" name="q" value="{{ $q }}">
            <p><input type="text" name="branche_name" placeholder="Nom de la branche"
                    value="{{ $branche->branche_name }}" required></p>
