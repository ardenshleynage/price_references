...
window.openProductModal = function (
    ...
    const statusText = { 1: "Actif", 2: "Supprimé" };
    ...
    if (status === 1 || status === 2) {
        actionsHtml =
            '<p><button type="button" class="action-btn edit-btn" onclick="window.location.href=\'/admins/products/edit-from-search/' +
            id +
            "?q=" +
            searchQuery +
            "'\">Modifier</button></p>";
    ...
    if (status === 1) {
        actionsHtml +=
            ...
            searchQuery +
            '"><p><button type="submit" class="action-btn block-btn">Mettre à la corbeille</button></p></form>' +
            '<form action="' +
            routes.erase +
            '" method="POST" id="productEraseForm"><input type="hidden" name="_token" value="' +
            csrfToken +
            '"><input type="hidden" name="prod_id" value="' +
            id +
            '"><input type="hidden" name="q" value="' +
            searchQuery +
            '"><p><button type="button" onclick="openSearchConfirmEraseModal(document.getElementById(\'productEraseForm\'))" class="action-btn delete-permanent-btn">Supprimer définitivement</button></p></form>';
    } else if (status === 2) {
        actionsHtml +=
            '<form action="' +
            routes.restore +
...
window.openUserModal = function (
    ...
    document.getElementById("searchModalUserEmail").textContent = email;
    ...
    if (status === 1 || status === 2) {
        actionsHtml =
            '<p><button type="button" class="action-btn edit-btn" onclick="window.location.href=\'/users/edit-from-search/' +
            id +
            "?q=" +
            searchQuery +
            "'\">Modifier</button></p>";
...
window.openCategoryModal = function (
    ...
    if (status === 1 || status === 2) {
        actionsHtml =
            '<p><button type="button" class="action-btn edit-btn" onclick="window.location.href=\'/admins/categories/edit-from-search/' +
            id +
            "?q=" +
            searchQuery +
            "'\">Modifier</button></p>";
    ...
    if (status === 1) {
        actionsHtml +=
            ...
            '<form action="' +
            eraseUrl +
            '" method="POST" id="categoryEraseForm"><input type="hidden" name="_token" value="' +
            csrfToken +
            '"><input type="hidden" name="category_id" value="' +
            id +
            '"><input type="hidden" name="q" value="' +
            searchQuery +
            '"><p><button type="button" onclick="openSearchConfirmEraseModal(document.getElementById(\'categoryEraseForm\'))" class="action-btn delete-permanent-btn">Supprimer définitivement</button></p></form>';
    } else if (status === 2) {
        actionsHtml +=
            '<form action="' +
            restoreUrl +
...
window.openBranchModal = function (
    ...
    if (status === 1 || status === 2) {
        actionsHtml =
            '<p><button type="button" class="action-btn edit-btn" onclick="window.location.href=\'/admins/branches/edit-from-search/' +
            id +
            "?q=" +
            searchQuery +
            "'\">Modifier</button></p>";
    ...
    if (status === 1) {
        actionsHtml +=
            ...
            '<form action="' +
            routes.erase +
            '" method="POST" id="branchEraseForm"><input type="hidden" name="_token" value="' +
            csrfToken +
            '"><input type="hidden" name="branche_id" value="' +
            id +
            '"><input type="hidden" name="q" value="' +
            searchQuery +
            '"><p><button type="button" onclick="openSearchConfirmEraseModal(document.getElementById(\'branchEraseForm\'))" class="action-btn delete-permanent-btn">Supprimer définitivement</button></p></form>';
    } else if (status === 2) {
        actionsHtml +=
            '<form action="' +
            routes.restore +
