document.addEventListener("DOMContentLoaded", function () {
    ...
    window.openUserModal = function (
        ...
        // Récupérer les IDs depuis les spans (DISPONIBLES POUR TOUS LES STATUS)
        const currentBranchId =
            document.getElementById("modalBranchId").textContent;
        ...
        if (status === 1) {
            actionsHtml = `
                <form onsubmit="openEditModal(${id}, '${product_name}', '${post_scriptum}', ${single_price}, '${detailed_price}', '${currentBranchId}', '${currentCategoryId}'); return false;">
